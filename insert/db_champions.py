...
chams_info = pd.read_csv("/Users/vvoo/mydjango_project_SW/lol_data/champion_line_position_cc.csv", index_col=False)
...
for index, row in chams_info.iterrows():
    ...
    curs.execute("""  INSERT IGNORE INTO mydjango_project.boards_champions
