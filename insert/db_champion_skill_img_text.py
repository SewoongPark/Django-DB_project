...
chams_info = pd.read_csv(r"/Users/vvoo/mydjango_project_SW/lol_data/champion_skill_img_text.csv", index_col=False)
...
for index, row in chams_info.iterrows():
    ...
    curs.execute("""  INSERT IGNORE INTO mydjango_project.boards_champion_skill_img_text
