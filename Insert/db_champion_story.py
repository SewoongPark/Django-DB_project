...
chams_info = pd.read_csv(r"C:\Users\efkje\OneDrive\바탕 화면\project\data\champion_story.csv", index_col=False)
...
for index, row in chams_info.iterrows():
    ...
    curs.execute("""  INSERT IGNORE INTO project.board_champion_story
