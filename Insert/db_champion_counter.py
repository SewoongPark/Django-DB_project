...
conn = pymysql.connect(host='127.0.0.1', user = 'root', password='qwer1234', db = 'project',charset = 'utf8') #본인 db password 입력, database 이름 입력 
curs = conn.cursor(pymysql.cursors.DictCursor)

chams_info = pd.read_csv(r"C:\Users\efkje\OneDrive\바탕 화면\project\data\champion_counter.csv", index_col=False) #csv 파일 저장된 경로 
...
for index, row in chams_info.iterrows():
    ...
    curs.execute("""  INSERT IGNORE INTO project.board_champion_counter      
